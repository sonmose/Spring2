...
public class HomeController {
	...
	public ModelAndView uploda(ModelAndView mView, MultipartFile myFile,HttpServletRequest request) {
	...
	public ModelAndView uploda2(ModelAndView mView, FileDto dto,HttpServletRequest request) {
